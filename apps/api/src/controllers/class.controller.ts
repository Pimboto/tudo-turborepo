...
export class ClassController {
  ...
  static async create(req: AuthenticatedRequest, res: Response) {
    ...
    const classData = await ClassService.createClass(studioId, partner.id, req.body);
    
    res.status(201).json(
      successResponse(classData, 'Class created successfully')
    );
  }
  ...
  static async updateStatus(req: AuthenticatedRequest, res: Response) {
    ...
    const updated = await ClassService.updateClassStatus(id, partner.id, status);
  ...
  static async getSessions(req: Request, res: Response) {
    ...
    const result = await ClassService.getClassSessions(id, {
      page,
      limit,
  ...
  static async duplicate(req: AuthenticatedRequest, res: Response) {
    ...
    res.status(201).json(
      successResponse(duplicate, 'Class duplicated successfully')
    );
  }
  ...
  static async getSessionAttendees(req: AuthenticatedRequest, res: Response) {
    ...
    const attendees = await ClassService.getSessionAttendees(sessionId, partner.id);
  ...
  static async getUpcomingSessions(req: Request, res: Response) {
    ...
    res.json(successResponse(sessions, undefined, {
      page,
      limit,
      total,
